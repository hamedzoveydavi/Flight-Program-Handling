...
class ContractController extends Controller
{
    ...
    public function store(ContractRequest $request)
    {
        $con = new Contract();
                ...
                if($con->save()){
                   // $ContractData = Contract::where('ContractNum',$request->input('Contract_No'))->first();

                    return view('layouts.includes.Contract.tbl',['cnnum'=>$request->input('Contract_No')]);

                 // return back()->withSuccessMessage(__('msg.Success'));
                } else {
