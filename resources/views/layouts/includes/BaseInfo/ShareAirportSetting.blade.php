         ...
         <form method="post" action="{{Route('ShareSettingStore')}}" >
           ...
           {{-----------------------------------------------------------------------------------}}
            ...
            {{--------------------------------end cell---------------------------------------------------}}
             ...
             <button  type="submit" class="btn btn-success"  style="width: 97%;" data-toggle="modal" data-target="#myModal" > <i class="fa fa-plus"></i> <i>Type</i></button>
